...
export interface ApiApplicationApplication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    developer_note: Schema.Attribute.Text;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.DefaultTo<'onay_bekliyor'>;
    ...
    user_info: Schema.Attribute.JSON;
  };
}
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    default_attr: Schema.Attribute.String;
    ...
    old_price: Schema.Attribute.Decimal &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    perks: Schema.Attribute.Component<'perks.simple', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    price: Schema.Attribute.Decimal &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    price_double_variant: Schema.Attribute.Component<
      'choices.twice-price',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    price_single_variant: Schema.Attribute.Component<
      'choices.single-price',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    short_text: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    vat_percent: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
  };
}
